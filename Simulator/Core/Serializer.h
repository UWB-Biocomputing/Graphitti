 ...
 *
 * @brief Handles implementation of serialization and deserialization of
 * synapses.
 *
 *  Serializes and Deserializes synapse weights, source vertices, destination
 * vertices, maxEdgesPerVertex, totalVertices and radii.
 */
...
public:
  ...
  Serializer &
  operator=(const Serializer &serializer) = default; // default copy assignment
  ...
  ///  maxEdgesPerVertex, totalVertices.
  ///  if running a connGrowth model and radii is in serialization file,
  ///  deserializes radii as well
  ///
