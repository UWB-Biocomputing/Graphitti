...
public:
   ...
   VectorMatrix(string t = "complete", string i = "const", int r = 1, int c = 1, BGFLOAT m = 0.0,
                string v = "");
  ...
  ******************************************/
   ...
   inline const BGFLOAT &operator[](int i) const
   {
      return theVector[i];
   }
   ...
   ///  @param i index
   ///  @return item within this VectorMatrix
   inline const BGFLOAT &at(int i) const
   {
      return theVector[i];
   }
  ...
  ******************************************/
   ...
   friend inline const VectorMatrix operator*(BGFLOAT c, const VectorMatrix &rhs)
   {
      return rhs * c;
   }
   ...
   ///  @param v The vector
   ///  @return A vector the same size as the rhs
   friend const VectorMatrix operator-(BGFLOAT c, const VectorMatrix &v);
   ...
   friend const VectorMatrix sqrt(const VectorMatrix &v);
