...
public:
  ...
  ///  device memory.
  virtual void
  copyNeuronDeviceSpikeHistoryToHost(void *allVerticesDevice) override;
  ...
  ///  device memory.
  virtual void
  copyNeuronDeviceSpikeCountsToHost(void *allVerticesDevice) override;
...
protected:
  ...
  ///
  ///  @param  allVerticesDevice         Reference to the
...
protected:
  ...
  virtual void initNeuronConstsFromParamValues(int neuronIndex,
...
public:
  ...
  ///  If \f$V_m\f$ exceeds \f$V_{thresh}\f$ a spike is emmited. [units=V;
  ///  range=(-10,100);]
  BGFLOAT *Vthresh_;
  ...
  ///  The initial condition for \f$V_m\f$ at time \f$t=0\f$. [units=V;
  ///  range=(-1,1);]
  BGFLOAT *Vinit_;
  ...
  /// The standard deviation of the noise to be added each integration time
  /// constant. [range=(0,1); units=A;]
  BGFLOAT *Inoise_;

  ///  A constant current to be injected into the LIF neuron. [units=A;
  ///  range=(-1,1);]
  BGFLOAT *Iinject_;
