...
extern __global__ void advanceLIFNeuronsDevice( int totalVertices, int maxSynapses, int maxSpikes, const BGFLOAT deltaT, uint64_t simulationStep, float* randNoise, AllIFNeuronsDeviceProperties* allVerticesDevice, AllSpikingSynapsesDeviceProperties* allEdgesDevice, EdgeIndexMap* synapseIndexMapDevice, bool fAllowBackPropagation );
