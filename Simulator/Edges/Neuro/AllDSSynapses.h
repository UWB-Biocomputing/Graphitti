...
public:
   ...
   AllDSSynapses(const int numVertices, const int maxSynapses);
...
protected:
   ...
   protected:
       ...
       ///  @param  numVertices            Number of vertices.
       ///  @param  maxEdgesPerVertex  Maximum number of synapses per neuron.
       void allocDeviceStruct( AllDSSynapsesDeviceProperties &allSynapses, int numVertices, int maxEdgesPerVertex );
