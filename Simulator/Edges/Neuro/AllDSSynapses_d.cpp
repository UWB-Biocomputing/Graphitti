...
void AllDSSynapses::allocEdgeDeviceStruct(void **allEdgesDevice,
  ...
  HANDLE_ERROR(
      cudaMalloc(allEdgesDevice, sizeof(AllDSSynapsesDeviceProperties)));
  HANDLE_ERROR(cudaMemcpy(*allEdgesDevice, &allEdges,
                          sizeof(AllDSSynapsesDeviceProperties),
...
///  @param  numVertices            Number of vertices.
///  @param  maxEdgesPerVertex  Maximum number of synapses per neuron.
void AllDSSynapses::allocDeviceStruct(AllDSSynapsesDeviceProperties &allEdges,
                                      int numVertices, int maxEdgesPerVertex) {
  AllSpikingSynapses::allocDeviceStruct(allEdges, numVertices,
                                        maxEdgesPerVertex);

  BGSIZE maxTotalSynapses = maxEdgesPerVertex * numVertices;

  HANDLE_ERROR(cudaMalloc((void **)&allEdges.lastSpike_,
                          maxTotalSynapses * sizeof(uint64_t)));
  HANDLE_ERROR(
      cudaMalloc((void **)&allEdges.r_, maxTotalSynapses * sizeof(BGFLOAT)));
  HANDLE_ERROR(
      cudaMalloc((void **)&allEdges.u_, maxTotalSynapses * sizeof(BGFLOAT)));
  HANDLE_ERROR(
      cudaMalloc((void **)&allEdges.D_, maxTotalSynapses * sizeof(BGFLOAT)));
  HANDLE_ERROR(
      cudaMalloc((void **)&allEdges.U_, maxTotalSynapses * sizeof(BGFLOAT)));
  HANDLE_ERROR(
      cudaMalloc((void **)&allEdges.F_, maxTotalSynapses * sizeof(BGFLOAT)));
}
...
///  AllDSSynapsesDeviceProperties struct
///                                  on device memory.
void AllDSSynapses::deleteDeviceStruct(
...
///  @param  numVertices            Number of vertices.
///  @param  maxEdgesPerVertex  Maximum number of synapses per neuron.
void AllDSSynapses::copyHostToDevice(
    void *allEdgesDevice, AllDSSynapsesDeviceProperties &allEdgesDeviceProps,
...
///  @param  numVertices                 Number of vertices.
///  @param  maxEdgesPerVertex       Maximum number of synapses per neuron.
void AllDSSynapses::copyDeviceToHost(
    AllDSSynapsesDeviceProperties &allEdgesDeviceProps) {
...
void AllDSSynapses::printGPUEdgesProps(void *allEdgesDeviceProps) const {
  ...
  BGSIZE size =
      Simulator::getInstance().getMaxEdgesPerVertex() * countVertices_;
  if (size != 0) {
