...
public:
   ...
   static const BGFLOAT DEFAULT_tau = 3e-3;         // The default synaptic time constant
   static const BGFLOAT DEFAULT_U = 0.4;            // The default synaptic efficiency
   static const BGFLOAT DEFAULT_delay_weight = 0;   // The default delay weight
