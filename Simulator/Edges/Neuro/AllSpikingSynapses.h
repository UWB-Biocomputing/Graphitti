...
public:
   ...
   static const BGFLOAT DEFAULT_tau;           // The default synaptic time constant
   static const BGFLOAT DEFAULT_U;             // The default synaptic efficiency
   static const BGFLOAT DEFAULT_delay_weight;  // The default delay weight
