...
protected:
   ...
   protected:
       ...
       ///  @param  numNeurons            Number of neurons.
       ///  @param  maxEdgesPerVertex  Maximum number of synapses per neuron.
       void allocDeviceStruct( AllSTDPSynapsesDeviceProperties &allSynapsesDevice, int numNeurons, int maxEdgesPerVertex );
       ...
       ///  @param  numNeurons              Number of neurons.
       ///  @param  maxEdgesPerVertex    Maximum number of synapses per neuron.
       void copyHostToDevice( void* allSynapsesDevice, AllSTDPSynapsesDeviceProperties& allSynapsesDeviceProps, int numNeurons, int maxEdgesPerVertex );
