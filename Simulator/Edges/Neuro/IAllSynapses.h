...
#include "Simulator/Core/SynapseIndexMap.h"
...
public:
   ...
   virtual void advanceSynapses(IAllVertices *neurons, SynapseIndexMap *synapseIndexMap) = 0;

   ///  Advance one specific Synapse.
   ///
   ///  @param  iSyn      Index of the Synapse to connect to.
   ///  @param  neurons   The Neuron list to search from.
   virtual void advanceSynapse(const BGSIZE iSyn, IAllVertices *neurons) = 0;
