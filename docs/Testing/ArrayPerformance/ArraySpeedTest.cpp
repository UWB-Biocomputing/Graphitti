...
int main()
{
   ...
   cout << "Array initialization took \t" << setw(output_width)
        << chrono::duration_cast<chrono::microseconds>(clockEnd - clockStart).count() << "µs"
        << endl;
   ...
   cout << "total sum: "
        << (arraySequentialOutput + vectorSequentialOutput + valarraySequentialOutput
            + arrayRandomOutput + vectorRandomOutput + valarrayRandomOutput
            + atVectorSequentialOutput + atVectorRandomOutput);
}