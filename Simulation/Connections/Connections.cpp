...
#if defined(USE_GPU)
void Connections::updateSynapsesWeights(const int numNeurons, IAllNeurons &neurons, IAllSynapses &synapses, AllSpikingNeuronsDeviceProperties* allNeuronsDevice_, AllSpikingSynapsesDeviceProperties* allSynapseDevice_, Layout *layout)
{
}
#else
